...
const updateMedicalOfficer = require('../../../../services/admin/users/medicalOfficer/updateMedicalOfficer');
...
router.post('/', async function (req, res) {
   ...
   await updateMedicalOfficer.updateMedicalOfficer(id, firstName, lastName, NIC, gender, dateOfBirth, address, email, mobileNumber).then(
      (user) => {
