...
const profileUpdate = require('../../services/registerDonor/profileUpdate');
...
router.post('/',async function(req, res) {
    ...
    const district = req.body.updateDistrict;
 ...
 if (NIC.length == 12) {
    ...
    await profileUpdate.updateDonor(id,firstName,lastName,NIC,gender,dateOfBirth,address,email,mobileNumber,province,district).then(
        (user) => {
