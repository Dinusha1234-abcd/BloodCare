...
const updateHeadNurse = require('../../../../services/clusterAdmin/medicalStaff/headNurse/updateHeadNurse');
...
router.post('/', async function (req, res) {
   ...
   await updateHeadNurse.updateHeadNurse(id, firstName, lastName, NIC, gender, dateOfBirth, address, email, mobileNumber).then(
      (user) => {
