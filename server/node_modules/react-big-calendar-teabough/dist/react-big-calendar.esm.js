...
function noOverlap (_ref) {
  ...
  styledEvents = _orderBy(styledEvents, [function (item) {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, TimeGutterHeader && React.createElement(TimeGutterHeader, null)), range.map(function (date, ii) {
      return React.createElement("div", {
        style: {
        ...
        key: "resource_" + ii
      }, _this4.renderHeaderCell(date, ii)), React.createElement("div", {
        className: "rbc-row rbc-time-header-cell"
      }, resources.map(function (_ref3, idx) {
        var id = _ref3[0],
            resource = _ref3[1];
        return resource && (resource.workingDays || [date.getDay()]).includes(date.getDay()) && React.createElement("div", {
          key: id,
          className: "rbc-header"
