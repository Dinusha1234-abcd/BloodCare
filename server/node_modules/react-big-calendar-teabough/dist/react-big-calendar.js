(function (global, factory) {
  ...
  */
  ...
  function noOverlap (_ref) {
    ...
    styledEvents = orderBy(styledEvents, [function (item) {
      return item.event.order;
    }, function (item) {
      return item.event.title;
    }], ['asc', 'asc']); // styledEvents.sort((a, b) => {
    //   a = a.style
    //   b = b.style
  ...
  function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      }, TimeGutterHeader && React__default.createElement(TimeGutterHeader, null)), range.map(function (date, ii) {
        return React__default.createElement("div", {
          style: {
          ...
          key: "resource_" + ii
        }, _this4.renderHeaderCell(date, ii)), React__default.createElement("div", {
          className: "rbc-row rbc-time-header-cell"
        }, resources.map(function (_ref3, idx) {
          var id = _ref3[0],
              resource = _ref3[1];
          return resource && (resource.workingDays || [date.getDay()]).includes(date.getDay()) && React__default.createElement("div", {
            key: id,
            className: "rbc-header"
  ...
  function (_Component) {
    ...
    _proto.renderEventDayColumn = function renderEventDayColumn(_ref) {
      var id = _ref.id,
          resource = _ref.resource,
          date = _ref.date,
          index1 = _ref.index1,
          index2 = _ref.index2,
          groupedEvents = _ref.groupedEvents,
          groupedBackgroundEvents = _ref.groupedBackgroundEvents,
          now = _ref.now;
      var _this$props2 = this.props,
          min = _this$props2.min,
          max = _this$props2.max,
    ...
    _proto.renderEvents = function renderEvents(range, events, backgroundEvents, now) {
      ...
      return range.map(function (date, index2) {
        var plainResources = resources.map(function (_ref2, index1) {
          var id = _ref2[0],
              resource = _ref2[1];
          return {
            index1: index1,
        ...
        return plainResources.filter(function (r) {
          return (r.resource.workingDays || [date.getDay]).includes(date.getDay());
        }).map(function (_ref3) {
          var id = _ref3.id,
              resource = _ref3.resource,
              index1 = _ref3.index1;
          return _this2.renderEventDayColumn({
            id: id,
            resource: resource,
            date: date,
            index1: index1,
