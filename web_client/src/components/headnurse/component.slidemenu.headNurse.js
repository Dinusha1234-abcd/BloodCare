    ...
    <main className={show ? 'space-toggle' : null}>
      ...
      '>
        ...
        <div id={`${ option ? 'user-select' : 'user-select-active' }`}>
          <Link  to='/headnurse/profile'  className='user-select-option-profile'>View Profile</Link><br/> 
        ...
        <nav className='nav'>
          <div>
            ...
            <div className='nav-list'>
              ...
              <Link to='/' className={`${(window.location.pathname === '/landingpage' ) ? 'nav-link-active' : 'nav-link'} `}>
              ...
              <Link to='/headnurse/calendar' className={`${(window.location.pathname === '/headnurse/calendar' ) ? 'nav-link-active ' : 'nav-link'} `}>
              <i className={`${(window.location.pathname === '/headnurse/calendar' ) ? 'fa-solid fa-calendar-days nav-link-icon-active' : 'fa-solid fa-calendar-days nav-link-icon'} `}></i>
                <span className={`${(window.location.pathname === '/headnurse/calendar' ) ? 'nav-link-icon-active' : 'nav-link-icon'} `}  >Calender</span>
              </Link>

              <Link to='/headnurse/assigncamps' className={`${(window.location.pathname === '/headnurse/assigncamps' ) ? 'nav-link-active ' : 'nav-link'} `}>
                <i className={`${(window.location.pathname === '/headnurse/assigncamps' ) ? 'fa-solid fa-campground nav-link-icon-active' : 'fa-solid fa-campground nav-link-icon'} `}></i>
                <span className={`${(window.location.pathname === '/headnurse/assigncamps' ) ? 'nav-link-icon-active' : 'nav-link-icon'} `}  >Blood Camps</span>
              </Link>
