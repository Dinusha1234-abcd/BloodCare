...
export default function APositive(){
    ...
    function getBloodCount() {
        ...
        axios.post("http://localhost:8070/blood/apositivecount", clusterAdmin).then(
            (res) => {
    ...
    function getBloodCamp() {
        ...
        axios.post("http://localhost:8070/blood/apositivecamp", clusterAdmin).then(
            (res) => {
    ...
    return(
        <div id='blood-display-container'>
            ...
            <h1 id='header-clusterAdmin-blood'>A Positive Blood Packets</h1>
            <div id='blood-display-container-box-1'>
                 ...
                 <div id='blood-display-container-subbox-1'>A Positive<br/><h id='blood-display-container-subbox-1-count'>{wait ?  (parseInt(data[0]['Apositive'])/ parseInt(data[0]['ApositiveAll']))*100 + '%': '0%' }</h><br/>Percentage</div>
           ...
           <div id='blood-display-container-box-2'>
                 <h1>Last 3 Months Camp Saving A+ Blood Packets</h1>
