...
export default function BNegative(){
    ...
    function getBloodCount() {
        ...
        axios.post("http://localhost:8070/blood/bnegativecount", clusterAdmin).then(
            (res) => {
    ...
    function getBloodCamp() {
        ...
        axios.post("http://localhost:8070/blood/bnegativecamp", clusterAdmin).then(
            (res) => {
    ...
    return(
        <div id='blood-display-container'>
            ...
            <h1 id='header-clusterAdmin-blood'>B Negative Blood Packets</h1>
            <div id='blood-display-container-box-1'>
               
                 <div id='blood-display-container-subbox-1'>Cluster Center <br/> <h id='blood-display-container-subbox-1-count'>{wait ?  data[0]['Bnegative'] :  '0' }</h> <br/>Packets</div>
                 <div id='blood-display-container-subbox-1'>All Cluster Center<br/><h id='blood-display-container-subbox-1-count'>{wait ?  data[0]['BnegativeAll'] :  '0' }</h> <br/>Packets </div>
                 <div id='blood-display-container-subbox-1'>B Negative<br/><h id='blood-display-container-subbox-1-count'>{wait ?  (parseInt(data[0]['Bnegative'])/ parseInt(data[0]['BnegativeAll']))*100 + '%': '0%' }</h><br/>Percentage</div>
