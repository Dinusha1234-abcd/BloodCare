...
export default function ANegative(){
    ...
    function getBloodCount() {
        ...
        axios.post("http://localhost:8070/blood/anegativecount", clusterAdmin).then(
            (res) => {
    ...
    function getBloodCamp() {
        ...
        axios.post("http://localhost:8070/blood/anegativecamp", clusterAdmin).then(
            (res) => {
    ...
    return(
        <div id='blood-display-container'>
            ...
            <h1 id='header-clusterAdmin-blood'>A Negative Blood Packets</h1>
           ...
           <div id='blood-display-container-box-2'>
                ...
                <tr>
                    ...
                    <th>Camp Number</th>
                    <th id='driver-action'>Number Of Packets Packets</th>
