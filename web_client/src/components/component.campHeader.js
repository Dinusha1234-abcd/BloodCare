...
export default function ClusterAdminCampHeader(){
    ...
    return (
        <div id="container-1">
            <Link to='/bloodcamp/pastcamp' id={`${(window.location.pathname=='/bloodcamp/pastcamp' ? 'box-1-active' : 'box-1' )}`} > <img src={pastCamp} id='box-1-pastCamp'  /><h className='camp-status'>Completed Camps</h>   </Link>
