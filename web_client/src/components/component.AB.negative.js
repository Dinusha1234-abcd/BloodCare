...
export default function ABNegative(){
    ...
    return(
        <div id='blood-display-container'>
            ...
            <h1 id='header-clusterAdmin-blood'>AB Negative Blood Counters</h1>
            <div id='blood-display-container-box-1'>
                 ...
                 <div id='blood-display-container-subbox-1'>AB Negative<br/><h id='blood-display-container-subbox-1-count'>100%</h><br/>Percentage</div>
           ...
           <div id='blood-display-container-box-2'>
                 <h1>Last 3 Months Camp Saving AB- Blood Counters</h1>
