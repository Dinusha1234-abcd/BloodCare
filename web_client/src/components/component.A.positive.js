...
export default function APositive(){
    ...
    return(
        <div id='blood-display-container'>
            ...
            <h1 id='header-clusterAdmin-blood'>A Positive Blood Counters</h1>
            <div id='blood-display-container-box-1'>
                 ...
                 <div id='blood-display-container-subbox-1'>A Positive<br/><h id='blood-display-container-subbox-1-count'>100%</h><br/>Percentage</div>
