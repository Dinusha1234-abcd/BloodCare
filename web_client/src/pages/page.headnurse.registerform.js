            ...
            <div id ="form-headnurse-donor-reg">
               ...
               <form id ="add-donor-headnurse">
                ...
                <br/><label id="form-label-headnurse">Did you donate blood before?</label> <br/> <br/>
                    <label id="blood-before1">Yes</label>
                       <input type="radio" id="radio1-headnurse" value="Yes"></input>
                    <label id="blood-before2">No</label>
                      <input type="radio" id="radio2-headnurse" value="No"></input>

                      <br/> <br/> <label id="form-label-headnurse">Did you have any diseases?</label> <br/> <br/>
                    <label id="diseases1">Yes</label>
                       <input type="radio" id="radio1-headnurse" value="Yes"></input>
                    <label id="diseases2">No</label>
                      <input type="radio" id="radio2-headnurse" value="No"></input>    
