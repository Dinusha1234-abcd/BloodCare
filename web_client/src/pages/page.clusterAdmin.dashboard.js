...
export default function ClusterAdminDashboard() {
  ...
  function getDate() {
    ...
    axios.post("http://localhost:8070/dashboard/medicalstaff", clusterAdmin).then(
      (res) => {
  ...
  function getBlood() {
    ...
    axios.post("http://localhost:8070/dashboard/blood", clusterAdmin).then(
      (res) => {
  ...
  function getCamp() {
    ...
    let a;
    axios.post("http://localhost:8070/dashboard/camp", clusterAdmin).then(
      (res) => {
